...
export const metadata = generateSEO({
  title: "Premium Agency Services & AI Solutions",
  description: "Comprehensive enterprise software engineering, AI product design, cloud architecture, and digital transformation services.",
  path: "/services",
});
